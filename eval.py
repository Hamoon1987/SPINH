...
parser.add_argument('--log_freq', default=1, type=int, help='Frequency of printing intermediate results')
...
def run_evaluation(model, dataset_name, dataset, result_file,
                   ...
                   num_workers=1, shuffle=False, log_freq=1):
    ...
    for step, batch in enumerate(tqdm(data_loader, desc='Eval', total=len(data_loader))):
        if step == 52:
            ...
            if eval_pose:
                ...
                print('MPJPE: ' + str(1000 * error))

                # Reconstuction_error
                r_error = reconstruction_error(pred_keypoints_3d.cpu().numpy(), gt_keypoints_3d.cpu().numpy(), reduction=None)
                recon_err[step * batch_size:step * batch_size + curr_batch_size] = r_error
                print('Reconstruction Error: ' + str(1000 * r_error))
                break
            ...
            # if step % log_freq == log_freq - 1:
                # if eval_pose:
            # print('MPJPE: ' + str(1000 * mpjpe[step]))
            # print('Reconstruction Error: ' + str(1000 * recon_err[step]))
            # print()
            #     # if eval_masks:
